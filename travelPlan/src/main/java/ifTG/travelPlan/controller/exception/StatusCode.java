...
public enum StatusCode {
    ...
    INVALID_DATE_FORMAT(HttpStatus.BAD_REQUEST, "3001", "유효하지 않은 날짜 형식입니다."),
    ...
    public static StatusCode getStateCode(StatusCodeMessageDto dto){
